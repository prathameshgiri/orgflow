      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-zinc-500">
            {task ? `Audit log for task: ${task.title}` : 'Loading task details...'}
          </p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden shadow-sm">
        <div className="p-6 border-b border-zinc-200 dark:border-zinc-800 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-500">All status and priority changes made to this task.</p>
          </div>
        </div>
        ...
        <div className="p-6">
          {loading ? (
            ...
            <div className="py-12 text-center text-zinc-500 flex flex-col items-center justify-center">
              ...
              <p className="text-zinc-500 max-w-sm">There are no recorded activities for this task yet.</p>
            </div>
          ) : (
