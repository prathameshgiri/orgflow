  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 ease-out">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Edit Problem</h1>
          <p className="text-zinc-500 text-sm">Update problem details and status.</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input id="rootCause" value={rootCause} onChange={(e) => setRootCause(e.target.value)} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="workaround">Workaround (Optional)</Label>
            <Input id="workaround" value={workaround} onChange={(e) => setWorkaround(e.target.value)} />
          </div>
