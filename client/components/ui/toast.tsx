  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-red-200/50 bg-red-50/95 text-red-900",
        success:
          "border-emerald-200/50 bg-emerald-50/95 text-emerald-900",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2.5 top-2.5 rounded-lg p-1 opacity-0 transition-all hover:opacity-100 group-hover:opacity-60 focus:opacity-100 focus:outline-none",
